...
import { k as set_current_component, r as run_all, l as current_component, o as onDestroy, p as get_store_value } from "./ssr.js";
  ...
  const trigger = makeElement(name("trigger"), {
    ...
    action: (node) => {
      ...
      const unsub = executeCallbacks(addMeltEventListener(node, "pointerenter", (e) => {
        ...
        if (!isElement$1(e.currentTarget) || !isFocusVisible(e.currentTarget))
          return;
        handleOpen.get()();
            ...
            options: {
              ...
              modal: {
                ...
                shouldCloseOnInteractOutside: (e) => {
                  ...
                  if (e.defaultPrevented)
                    return false;
                  if (isHTMLElement$1($activeTrigger) && $activeTrigger.contains(e.target))
                    return false;
                  return true;
                }
              },
