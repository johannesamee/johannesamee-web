...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<nav class="svelte-1ihufdv"><div class="navbar px-0 bg-base-100 mb-8 z-10"><div class="avatar" data-svelte-h="svelte-wc7zah"><div class="w-12 rounded-full"><img src="https://media.licdn.com/dms/image/D4D03AQEXI0MHYf3fQA/profile-displayphoto-shrink_800_800/0/1710513333483?e=1724889600&v=beta&t=Da52QVeoZ8fdB5Ch-5WrqVHyAyMmG5S2VfdOVFNIxds" alt="Linkedin Profile Picture"></div></div> <div class="flex-1"><a href="/" class="btn btn-ghost text-xl svelte-1ihufdv">${escape(title)}</a></div> <div class="flex-none" data-svelte-h="svelte-1xy3o6k"><ul class="menu menu-horizontal px-1"><li class="svelte-1ihufdv"><a href="/rss.xml" target="_blank" class="svelte-1ihufdv">RSS</a></li> <li class="svelte-1ihufdv"><details><summary>More</summary> <ul class="bg-base-100 rounded-t-none p-2"><li class="svelte-1ihufdv"><a href="/about" class="svelte-1ihufdv">About</a></li> <li class="svelte-1ihufdv"><a href="/contact" class="svelte-1ihufdv">Contact</a></li></ul></details></li></ul></div></div>  </nav>`;
});
const css = {
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  return `<div class="layout max-w-screen-lg mx-auto">${validate_component(Header, "Header").$$render($$result, {}, {}, {})} <main class="">${validate_component(Transition, "PageTransition").$$render($$result, { url: data.url }, {}, {
    default: () => {
      return `${slots.default ? slots.default({}) : ``}`;
    }
